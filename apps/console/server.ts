/** biome-ignore-all lint/performance/useTopLevelRegex: copy-paste this file from `https://tanstack.com/start/latest/docs/framework/react/guide/hosting#bun` */
/** biome-ignore-all lint/style/useTemplate: copy-paste this file from `https://tanstack.com/start/latest/docs/framework/react/guide/hosting#bun` */
/** biome-ignore-all lint/style/noSubstr: copy-paste this file from `https://tanstack.com/start/latest/docs/framework/react/guide/hosting#bun` */
/** biome-ignore-all lint/style/noNestedTernary: copy-paste this file from `https://tanstack.com/start/latest/docs/framework/react/guide/hosting#bun` */
/** biome-ignore-all lint/complexity/noExcessiveCognitiveComplexity: copy-paste this file from `https://tanstack.com/start/latest/docs/framework/react/guide/hosting#bun` */
/** biome-ignore-all lint/correctness/noUndeclaredVariables: copy-paste this file from `https://tanstack.com/start/latest/docs/framework/react/guide/hosting#bun` */
/** biome-ignore-all lint/complexity/noForEach: copy-paste this file from `https://tanstack.com/start/latest/docs/framework/react/guide/hosting#bun` */
